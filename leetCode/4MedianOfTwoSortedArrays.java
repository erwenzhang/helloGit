public float findMedianSortedArray(int[] array1, int[] array2){ 
  ...
  if(total%2==1) return findKthElement(array1,0,array1.length-1,array2, 0, array2.length-1,total/2+1);
  else{
      float mid1 = findKthElement(array1,0, array1.length-1,array2,0,array2.length-1,total/2);
